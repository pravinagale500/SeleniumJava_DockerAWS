...
public class FlightConfirmationPage extends AbstractPage {
    ...
    private WebElement flightConfirmationButton;
    ...
    @Override
    public boolean isAt() {
        this.wait.until(ExpectedConditions.visibilityOf(this.flightConfirmationButton));
        return this.flightConfirmationButton.isDisplayed();
    }


    public String getPrice() {
        String confirmation = this.flightConfirmationButton.getText();
